...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "VIDPRO" },
      { property: "og:image", content: "/og-image.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "VIDPRO — Cinematic Creator OS" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "VIDPRO — Cinematic Creator OS" },
      { name: "twitter:description", content: "The cinematic AI operating system for serious creators." },
